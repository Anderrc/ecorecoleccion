...
const DashboardPage = () => {
	...
	const recentActivity = [
		{
			id: 1,
			action: 'Nueva recolección registrada',
		...
		{
			id: 4,
			action: 'Material procesado',
			location: '150kg Plástico',
			time: 'Hace 8 horas',
			type: 'procesado',
		},
	];
			...
			<div className="space-y-4 sm:space-y-6">
						...
						<div className="h-48 sm:h-64 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg flex items-center justify-center border border-green-100">
							<div className="text-center">
								<div className="w-12 h-12 mx-auto mb-3 bg-eco-primary/10 rounded-full flex items-center justify-center">
									<svg
										className="h-6 w-6 text-eco-primary"
										fill="none"
										viewBox="0 0 24 24"
										stroke="currentColor"
									>
								...
								>
									<div
										className={`flex-shrink-0 w-2 h-2 rounded-full mt-2 ${
											activity.type === 'recoleccion'
												? 'bg-eco-primary'
												: activity.type === 'usuario'
												? 'bg-eco-secondary'
												: activity.type === 'completado'
												? 'bg-green-500'
												: 'bg-eco-accent'
										}`}
									/>
				...
				<Card className="dashboard-card" padding="lg">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
						<Button
							variant="outline"
							className="h-16 sm:h-20 flex-col p-3"
						>
							<svg
